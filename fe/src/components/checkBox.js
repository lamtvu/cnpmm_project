...
const CheckBox = ({ defaultChecked, onChange, lableString, value, ...rest }) => {
    return (
        <div {...rest}>
            <div className="flex items-center">
                <label className='flex'>
                    <input type="checkbox" value={value} onChange={(e) => { onChange && onChange(e) }} className=' appearance-none' defaultChecked={defaultChecked} />
