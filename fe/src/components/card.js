...
import { formatStringLength, numberToPrice } from '../services/formatService';
...
const Card = ({ productData, size, ...rest }) => {
    ...
    return (
        <div className='rounded-lg p-2 bg-white relative transform hover:shadow-lg shadow-md overflow-hidden'
            ...
            <div className='p-2'>
                <div className='capitalize text-lg font-semibold text-gray-600'>
                    {formatStringLength(productData.name)}
                </div>
